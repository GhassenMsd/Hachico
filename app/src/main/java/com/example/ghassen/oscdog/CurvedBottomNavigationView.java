...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    private void initView() {
        ...
        mPaint.setColor(0xFECC3D);
        setBackgroundColor(0xFECC3D);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mFirstCurveStartPoint.set((mNavigationBarWidth/6)
        ...
        mSecondCurveEndPoint.set((mNavigationBarWidth/6)+(CURVE_CIRCLE_RADIUS*2)+(CURVE_CIRCLE_RADIUS/3)
                ,0);
